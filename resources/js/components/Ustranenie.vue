...
export default {
    ...
    methods: {
        initialize () {
            axios.post('/axios-send/ustran',{status: 'all'}).then(respond => {
        ...
        deleteItemConfirm () {
            ...
            axios.post('/axios-send/ustranDelete', {item: this.editedItem}).then(respond => {
                this.items = respond.data
            })
            this.closeDelete()
        },
        ...
        save (item) {
            ...
            this.close()
            axios.post('/axios-send/ustranEditOrNew', {item: item}).then(respond => {
                this.items = respond.data
