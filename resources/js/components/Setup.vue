    ...
    <div>
        <v-container fluid class="pt-12">
            <v-row>
                ...
                <status></status>
                <ustranenie></ustranenie>
                <vidgar></vidgar>
                <vina></vina>
                <working-statuses></working-statuses>
                <purposes></purposes>
            </v-row>
        </v-container>
    </div>
...
<script>
     ...
     export default {
         ...
         methods: {
             initialize () {
                 axios.post('/axios-send/garantiy',{status: 'all'}).then(respond => {
             ...
             deleteItemConfirm () {
                 ...
                 axios.post('/axios-send/garantiyDelete', {item: this.editedItem}).then(respond => {
                     this.items = respond.data
                 })
                 this.closeDelete()
             },
             ...
             save (item) {
                 ...
                 this.close()
                 axios.post('/axios-send/garantiyEditOrNew', {item: item}).then(respond => {
                     this.items = respond.data
