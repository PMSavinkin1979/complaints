...
export default {
    ...
    methods: {
        initialize () {
            axios.post('/axios-send/status',{status: 'all'}).then(respond => {
        ...
        deleteItemConfirm () {
            ...
            axios.post('/axios-send/statusDelete', {item: this.editedItem}).then(respond => {
                this.items = respond.data
            })
            this.closeDelete()
        },
        ...
        save (item) {
            ...
            this.close()
            axios.post('/axios-send/statusEditOrNew', {item: item}).then(respond => {
                this.items = respond.data
