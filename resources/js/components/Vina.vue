...
export default {
    ...
    methods: {
        initialize () {
            axios.post('/axios-send/vina',{status: 'all'}).then(respond => {
        ...
        deleteItemConfirm () {
            ...
            axios.post('/axios-send/vinaDelete', {item: this.editedItem}).then(respond => {
                this.items = respond.data
            })
            this.closeDelete()
        },
        ...
        save (item) {
            ...
            this.close()
            axios.post('/axios-send/vinaEditOrNew', {item: item}).then(respond => {
                this.items = respond.data
