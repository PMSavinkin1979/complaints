...
export default {
    ...
    methods: {
        initialize () {
            axios.post('/axios-send/vidgarantiy',{status: 'all'}).then(respond => {
        ...
        deleteItemConfirm () {
            ...
            axios.post('/axios-send/vidgarantiyDelete', {item: this.editedItem}).then(respond => {
                this.items = respond.data
            })
            this.closeDelete()
        },
        ...
        save (item) {
            ...
            this.close()
            axios.post('/axios-send/vidgarantiyEditOrNew', {item: item}).then(respond => {
                this.items = respond.data
